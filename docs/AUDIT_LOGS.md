...
**Users can view their own audit logs** through the `/api/audit-logs/me` endpoint for security monitoring and activity tracking. See [AUDIT_LOGS_USER_ACCESS.md](./AUDIT_LOGS_USER_ACCESS.md) for the complete user guide.
