...
Threats were ranked using impact versus likelihood. Smart contract tampering, authentication spoofing, KYC data exposure, and denial-of-service attacks were identified as the highest-risk threats due to their financial, privacy, and operational impact.
...
Security controls are applied across all layers of the system, ensuring that failures at one layer do not compromise the entire platform.
