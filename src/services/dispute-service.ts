...
export async function createDispute(
  ...
  await notifyDisputeParties({ contract, disputeId: createdDispute.id, milestoneId: input.milestoneId, milestone, project, contractId: input.contractId, reason: input.reason });
