/**
 * KYC Blockchain Contract Tests (Refactored)
...
} from '../../services/kyc-contract.js';
import { clearTransactions } from '../../services/blockchain-client.js';
import { createTestUser } from '../helpers/test-data-factory.js';

describe('KYC Blockchain Contract', () => {
  const testWallet = '0x' + 'a'.repeat(40);
  const testUserId = createTestUser().id;
