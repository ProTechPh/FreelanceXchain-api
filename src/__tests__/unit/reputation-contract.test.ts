...
const mockBlockchainRatingRepository = {
  ...
  queryAll: jest.fn(),
  findByContractAndRater: jest.fn(),
  delete: jest.fn(),
};
...
describe('Reputation Contract', () => {
  ...
  describe('getRatingsFromBlockchain', () => {
    it('should return ratings for user', async () => {
      ...
      mockBlockchainRatingRepository.findByRatee.mockResolvedValueOnce({
        items: [
          ...
          { id: 'r-2', contract_id: 'c-2', rater_id: 'u-3', ratee_id: 'u-2', rating: 4, comment: undefined, timestamp: 2000, transaction_hash: '0xtx2' },
        ],
        hasMore: false,
        total: 2,
      });
    ...
    it('should return empty array on error', async () => {
      ...
      mockBlockchainRatingRepository.findByRatee.mockRejectedValueOnce(new Error('DB error'));
  ...
  describe('getRatingsGivenByUser', () => {
    it('should return ratings given by user', async () => {
      ...
      mockBlockchainRatingRepository.findByRater.mockResolvedValueOnce({
        items: [{ id: 'r-1', contract_id: 'c-1', rater_id: 'u-1', ratee_id: 'u-2', rating: 5, comment: '', timestamp: 1000, transaction_hash: '0xtx' }],
        hasMore: false,
        total: 1,
      });
    ...
    it('should return empty array on error', async () => {
      ...
      mockBlockchainRatingRepository.findByRater.mockRejectedValueOnce(new Error('DB error'));
  ...
  describe('getRatingById', () => {
    it('should return rating by id', async () => {
      ...
      mockBlockchainRatingRepository.getRatingById.mockResolvedValueOnce({
        id: 'r-1', contract_id: 'c-1', rater_id: 'u-1', ratee_id: 'u-2', rating: 5, comment: '', timestamp: 1000, transaction_hash: '0xtx',
      });
    ...
    it('should return null when not found', async () => {
      ...
      mockBlockchainRatingRepository.getRatingById.mockResolvedValueOnce(null);
  ...
  describe('getRatingsByContract', () => {
    it('should return ratings for contract', async () => {
      ...
      mockBlockchainRatingRepository.queryAll.mockResolvedValueOnce([
        { id: 'r-1', contract_id: 'c-1', rater_id: 'u-1', ratee_id: 'u-2', rating: 5, comment: '', timestamp: 1000, transaction_hash: '0xtx' },
      ]);
    ...
    it('should return empty array on error', async () => {
      ...
      mockBlockchainRatingRepository.queryAll.mockRejectedValueOnce(new Error('DB error'));
  ...
  describe('hasUserRatedForContract', () => {
    it('should return true when rating exists', async () => {
      ...
      mockBlockchainRatingRepository.findByContractAndRater.mockResolvedValueOnce({
        id: 'r-1', contract_id: 'c-1', rater_id: 'u-1', ratee_id: 'u-2', rating: 5, comment: '', timestamp: 1000, transaction_hash: '0xtx',
      });
    ...
    it('should return false when no rating exists', async () => {
      ...
      mockBlockchainRatingRepository.findByContractAndRater.mockResolvedValueOnce(null);
  ...
  describe('clearBlockchainRatings', () => {
    it('should clear ratings in test environment', async () => {
      ...
      mockBlockchainRatingRepository.queryAll.mockResolvedValueOnce([{ id: 'rating-1' }]);
      mockBlockchainRatingRepository.delete.mockResolvedValueOnce(true);
