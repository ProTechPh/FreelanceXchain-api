...
- **1.0.56+build.650dc1b** (2026-09-18) - commit `650dc1b`: Merge pull request #298 from ProTechPh/security
- **1.0.55+build.beb3e00** (2026-09-18) - commit `beb3e00`: Merge pull request #297 from ProTechPh/security
- **1.0.54+build.01186d1** (2026-09-17) - commit `01186d1`: Merge pull request #295 from ProTechPh/security
- **1.0.53+build.0b7d748** (2026-09-16) - commit `0b7d748`: Merge pull request #294 from ProTechPh/security
- **1.0.52+build.a9a55ea** (2026-09-14) - commit `a9a55ea`: Merge pull request #292 from ProTechPh/security
- **1.0.51+build.f9dd608** (2026-09-14) - commit `f9dd608`: Merge pull request #291 from ProTechPh/security
- **1.0.50+build.d010dda** (2026-09-13) - commit `d010dda`: Merge pull request #290 from ProTechPh/security
...
- **1.0.45+build.1fd98ca** (2026-09-12) - commit `1fd98ca`: Merge pull request #285 from ProTechPh/stripe_integration
- **1.0.44+build.17a8dc3** (2026-09-11) - commit `17a8dc3`: Merge pull request #281 from ProTechPh/security
- **1.0.43+build.d3d95f8** (2026-09-11) - commit `d3d95f8`: Merge pull request #280 from ProTechPh/login-bug
- **1.0.42+build.1783d8d** (2026-09-11) - commit `1783d8d`: Merge pull request #279 from ProTechPh/login-bug
- **1.0.41+build.5aea324** (2026-09-08) - commit `5aea324`: Merge pull request #278 from ProTechPh/security
- **1.0.40+build.339f1ff** (2026-09-07) - commit `339f1ff`: Merge pull request #275 from ProTechPh/security
- **1.0.39+build.047cb68** (2026-09-07) - commit `047cb68`: Merge pull request #274 from ProTechPh/security
- **1.0.38+build.89f890e** (2026-09-06) - commit `89f890e`: Merge pull request #273 from ProTechPh/security
- **1.0.37+build.442b188** (2026-09-06) - commit `442b188`: Merge pull request #272 from ProTechPh/security
- **1.0.36+build.2d4ef0f** (2026-09-06) - commit `2d4ef0f`: Merge pull request #271 from ProTechPh/security
- **1.0.35+build.67c9a3f** (2026-09-06) - commit `67c9a3f`: Merge pull request #270 from ProTechPh/security
- **1.0.34+build.2b89201** (2026-09-06) - commit `2b89201`: Merge pull request #269 from ProTechPh/ux
- **1.0.33+build.3e4348c** (2026-09-06) - commit `3e4348c`: Merge pull request #268 from ProTechPh/ux
- **1.0.32+build.5838cde** (2026-09-05) - commit `5838cde`: Merge pull request #267 from ProTechPh/security
- **1.0.31+build.1abe70b** (2026-09-03) - commit `1abe70b`: Merge pull request #266 from ProTechPh/ux
- **1.0.30+build.c94ed59** (2026-09-02) - commit `c94ed59`: Merge pull request #265 from ProTechPh/ux
- **1.0.29+build.cb170b4** (2026-08-31) - commit `cb170b4`: Merge pull request #264 from ProTechPh/blockchain
- **1.0.28+build.51a63a7** (2026-08-31) - commit `51a63a7`: Merge pull request #261 from ProTechPh/blockchain
- **1.0.27+build.40ff8fc** (2026-08-31) - commit `40ff8fc`: Merge pull request #260 from ProTechPh/blockchain
- **1.0.26+build.b55db19** (2026-08-29) - commit `b55db19`: Merge pull request #259 from ProTechPh/employee
- **1.0.25+build.aae9601** (2026-08-29) - commit `aae9601`: Merge pull request #258 from ProTechPh/employee
- **1.0.24+build.5cd96eb** (2026-08-29) - commit `5cd96eb`: Merge pull request #257 from ProTechPh/employee
...
- **1.0.9+build.48ca682** (2026-08-17) - commit `48ca682`: Merge pull request #246 from ProTechPh/improvement
- **1.0.8+build.d529141** (2026-08-17) - commit `d529141`: Merge pull request #245 from ProTechPh/improvement
- **1.0.7+build.e2665a5** (2026-08-17) - commit `e2665a5`: Merge pull request #244 from ProTechPh/clean-code
...
- **Package Manager**: Replaced all remaining `npm test` / `npm run` references with `pnpm` equivalents in contracts/README.md, appwrite/README.md, docs/blockchain/testing.md, docs/blockchain/test-results.md, docs/guides/troubleshooting.md, src/**tests**/README.md
